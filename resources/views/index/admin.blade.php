...
<div class="flex flex-row justify-evenly items-center ">
    ...
    @csrf
    @method('delete')
    <button class="font-semibold hover:underline mt-4 text-white dark:text-gray-900"  type="submit">Eliminar</button>
</form>
<a href="{{ route('edit',$universo) }}" class="font-semibold text-white dark:text-gray-900 hover:underline">Editar</a>
<a href="{{ route('sesion') }}" class="font-semibold text-white dark:text-gray-900  hover:underline">Volver</a>
</div>
